...
const OPTIONS = [
  ...
  },
  {
    key: "politeness",
    label: "Вежливость",
    description: "Извинения, уважительное обращение, готовность помочь",
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
  ...
  },
  {
    ...
    description: "Профессиональная лексика, формальные обращения",
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
  ...
  {
    key: "empathy",
    label: "Эмпатия и индивидуальный подход",
    description: "Признание эмоций клиента, адаптация решения под запрос",
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
